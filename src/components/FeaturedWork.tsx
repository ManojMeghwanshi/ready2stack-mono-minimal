...
const FeaturedWork = () => {
  return <section className="container mx-auto px-6 py-24 md:py-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {caseStudies.map(study => <Card key={study.id} className="group cursor-pointer border-2 border-foreground hover:bg-foreground hover:text-background transition-all duration-300">
